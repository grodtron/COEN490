...
public class BluetoothLeService extends Service {
  ...
  public final static String ACTION_DATA_SET_NOTIF = "ti.android.ble.common.ACTION_DATA_SET_NOTIF";
  ...
  private BluetoothGattCallback mGattCallbacks = new BluetoothGattCallback() {
    ...
    public void onDescriptorWrite(BluetoothGatt gatt, BluetoothGattDescriptor descriptor, int status) {
      ...
      BluetoothLeService.this.broadcastUpdate(ACTION_DATA_SET_NOTIF, descriptor, status);
    }
  };
  ...
  private void broadcastUpdate(String action, BluetoothGattDescriptor descriptor, int status)
  {
    final Intent intent = new Intent(action);
